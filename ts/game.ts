...
class Game {
    ...
    private pointLight1: BABYLON.PointLight;
    private pointLight2: BABYLON.PointLight;
    ...
    animateBox(): void {
        ...
        var animationBox = new BABYLON.Animation("boxAnimation", "rotation.x", 30, BABYLON.Animation.ANIMATIONTYPE_FLOAT,
